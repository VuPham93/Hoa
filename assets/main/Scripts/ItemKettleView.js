    ...
    m = function (t) {
        ...
        return i(e, t),
            ...
            e.prototype.onEventOnDataChange = function (t) {
                t.obj.model == c.dm.player.saveKey && [h.default.Config.kettle.key, "kettle_prefab"].includes(t.obj.key) && this.refreshNum()
            },
            e.prototype.refreshNum = function () {
                c.dm.player.kettle_prefab > 0 ? this.lb_num.string = "Thử" : 0 == c.dm.player.kettle ? this.lb_num.string = "+" : this.lb_num.string = c.dm.player.kettle + ""
            },
            e.prototype.onEventOnBoom = function (t) {
                if (t.tType == a.RewardType.Kettle) {
